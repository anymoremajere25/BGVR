...
- **Scalable searching in multi-omics data**: With the advent of multi-omics (e.g., genomics, transcriptomics, proteomics), we will examine algorithms and tools designed to search and integrate data from multiple sources, facilitating systems biology and personalized medicine research. To be conducted here are experiments 3.2.1, 3.2.2, 3.2.3, 3.3.1,3.4.1
